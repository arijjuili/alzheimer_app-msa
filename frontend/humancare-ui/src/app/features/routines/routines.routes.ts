...
import { PatientRoutinesComponent } from './components/patient/patient-routines.component';
...
export const ROUTINES_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      { path: 'patient', component: PatientRoutinesComponent, canActivate: [RoleGuard], data: { roles: [Role.PATIENT] } },
